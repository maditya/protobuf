...
import _ "github.com/maditya/protobuf/test/combos/both"
...
func BenchmarkMessageProtoUnmarshal(b *testing.B) {
	...
	for i := 0; i < 10000; i++ {
		data, err := github_com_maditya_protobuf_proto.Marshal(NewPopulatedMessage(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = data
...
func BenchmarkNestedProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		data, err := github_com_maditya_protobuf_proto.Marshal(NewPopulatedNested(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = data
...
func BenchmarkAllMapsProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		data, err := github_com_maditya_protobuf_proto.Marshal(NewPopulatedAllMaps(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = data
...
func BenchmarkAllMapsOrderedProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		data, err := github_com_maditya_protobuf_proto.Marshal(NewPopulatedAllMapsOrdered(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = data
...
func BenchmarkMessageWithMapProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		data, err := github_com_maditya_protobuf_proto.Marshal(NewPopulatedMessageWithMap(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = data
...
func BenchmarkFloatingPointProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		data, err := github_com_maditya_protobuf_proto.Marshal(NewPopulatedFloatingPoint(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = data
...
func BenchmarkUint128PairProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		data, err := github_com_maditya_protobuf_proto.Marshal(NewPopulatedUint128Pair(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = data
...
func BenchmarkContainsNestedMapProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		data, err := github_com_maditya_protobuf_proto.Marshal(NewPopulatedContainsNestedMap(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = data
...
func BenchmarkContainsNestedMap_NestedMapProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		data, err := github_com_maditya_protobuf_proto.Marshal(NewPopulatedContainsNestedMap_NestedMap(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = data
