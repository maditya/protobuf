...
func OneDescription() (desc *github_com_maditya_protobuf_protoc_gen_gogo_descriptor.FileDescriptorSet) {
	...
	var gzipped = []byte{
		...
		0x5c, 0x5b, 0x7e, 0xda, 0xc0, 0xbd, 0x20, 0x08, 0x7a, 0x2f, 0xd0, 0xc4, 0x76, 0xd2, 0xd4, 0x40,
		...
		0xb1, 0xbf, 0x5f, 0x1b, 0x98, 0xde, 0xe5, 0x0f, 0x75, 0x7a, 0x6f, 0x4a, 0x30, 0xd5, 0xd7, 0xa5,
		0xfd, 0xbf, 0x9a, 0xdd, 0x1b, 0x49, 0x98, 0x1d, 0x81, 0x43, 0x15, 0xde, 0xce, 0xb2, 0x0e, 0xfb,
		0x63, 0xe3, 0x3c, 0x6b, 0x99, 0x54, 0xcb, 0x03, 0xdd, 0xf5, 0x79, 0xf7, 0xfb, 0x34, 0xc8, 0x66,
		0x13, 0xdb, 0xbe, 0xd9, 0x32, 0xb1, 0xcb, 0x5f, 0xc1, 0x59, 0x8f, 0x3b, 0x1d, 0xca, 0xd9, 0x5b,
		0xf8, 0x4f, 0x03, 0xea, 0x3a, 0x9e, 0xe9, 0x9b, 0xf7, 0xb0, 0x66, 0xda, 0xe2, 0x7d, 0x9d, 0xf4,
		...
		0x35, 0x9c, 0x7f, 0x11, 0xb2, 0xc2, 0x0f, 0xa4, 0x9a, 0x11, 0x4f, 0x68, 0x5d, 0x76, 0x5d, 0x93,
		0x58, 0xca, 0xa9, 0x59, 0x5b, 0x28, 0x2f, 0x43, 0xc1, 0xf4, 0xb4, 0xf0, 0xde, 0x30, 0xb1, 0x90,
		0x58, 0xca, 0xaa, 0x79, 0xd3, 0x0b, 0x2e, 0x8a, 0x16, 0xdf, 0x49, 0x40, 0xb1, 0xff, 0xde, 0x13,
		0x6d, 0x41, 0xd6, 0x72, 0x0c, 0x9d, 0x06, 0x02, 0xbb, 0x74, 0x5f, 0x8a, 0xb9, 0x2a, 0x5d, 0xde,
		0xe5, 0xf6, 0x6a, 0x80, 0x9c, 0xff, 0x07, 0x09, 0xb2, 0x42, 0x8c, 0x2e, 0x40, 0xaa, 0xab, 0xfb,
		...
		0x10, 0x94, 0xa1, 0x97, 0x6a, 0x8f, 0x72, 0x83, 0x2d, 0xae, 0x17, 0xd8, 0xc5, 0xef, 0x48, 0x30,
		...
		,
		...
		,
	}
